 ...
 */
let MainVisualizer = ({dispatch, files, render_count, task, center, data_range,enableOrtho}) => {
  ...
  if (enableOrtho) {
    CanvasElement = <Canvas
      ...
      <OrbitalControls center={center} data_range={data_range} isOrtho={enableOrtho}/>
      {visualizers}
...
const mapStateToProps = (newState) => {
  console.log('RE render!'+newState.render_count)
  let files = [], task = null, enableOrtho = false
  if (!newState)
