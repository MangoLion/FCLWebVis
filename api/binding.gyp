  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        './addons/nguyenphan/Graph.cpp',
        './addons/nguyenphan/sample.cpp',
        './addons/nguyenphan/bernard.cpp',
        './addons/nguyenphan/kdtree.cpp',
        './addons/nguyenphan/Reader.cpp',
        './addons/nguyenphan/tornado.cpp',
      ...
      'include_dirs': [
        ...
        './addons/nguyenphan/glm',
        './addons/nguyenphan/SparseMatrix',
      ],
